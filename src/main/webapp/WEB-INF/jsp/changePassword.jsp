...
<body>
	<div>
		...
		<div class="right-menu">
			...
			<div class="x-left">
				<form action="passWordForm"
					...
					<div class="input-group ">
						<label class="input-label"><b>用户名称：
								${user.getUsername()}</b></label>

					</div>
					<div class="input-group ">
						<label class="input-label"><b>旧密码：</b></label>&nbsp &nbsp <input
							id="oldpassword" name="password" type="password" class="input"
							placeholder="请输入旧密码！">
					</div>
					<div class="input-group ">
			...
			<div class="x-right">
				...
				<hr style="border: 1px dotted #808080" />
				<b> 不能使用的密码举例 : </b> 你的登录名加上数字如[leon01] <br> 你自己,同事,家人或宠物的名字等 <br>
				电话号码生日或者其他证件号码 <br> 键盘上相邻的按建例如"asdf" <br> 任何一个可在字典中直到的单词
			</div>
    ...
    function verifyRegisterBeforeSave() {
        ...
        if (newpassword ===""|| repeatPassword === "" || oldpassword === "") {
            alert("请确认是否有空缺项！");
           return false;
        } else if (oldpassword != accountPassword ) {
            alert("旧密码验证失败！");
            return false;
